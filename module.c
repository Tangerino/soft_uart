...
#if CODI == 1
const char *driver_name = "soft_uart1";
const char *name = "ttyCODI1";
...
#else
const char *driver_name = "soft_uart2";
const char *name = "ttyCODI2";
...
static int __init soft_uart_init(void) {
    ...
    soft_uart_driver->driver_name = driver_name;
    soft_uart_driver->name = name;
    ...
    soft_uart_driver->init_termios.c_ispeed = 110;
    soft_uart_driver->init_termios.c_ospeed = 110;
    soft_uart_driver->init_termios.c_cflag = B110 | CREAD | CS8 | CLOCAL;
